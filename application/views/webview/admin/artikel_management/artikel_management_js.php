...
<script>
    let jquery_datatable = $("#table_artikel").DataTable({
        ...
        ajax: {
            url: "<?php echo site_url('Artikel_Management/ajax_list') ?> ",
            type: "POST",
            data: function(data) {}
        },
        columnDefs: [{
        ...
        if (!ttlkategoriValue) {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    var url;
                    var formData;
                    url = "<?php echo site_url('Artikel_Management/save') ?>";
        ...
        if (!ttlkategoriValue) {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    var url;
                    var formData;
                    url = "<?php echo site_url('Artikel_Management/proses_update') ?>";
    ...
    function onDelete(id) {
        ...
        swalWithBootstrapButtons.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: "<?php echo site_url('Artikel_Management/delete') ?>",
                    type: "POST",
                    data: {
                        id_delete: id
                    },
